...
RectWindow::RectWindow(): rCaptureRect({0,0,0,0}), rDraggingRect({0,0,0,0})
{
    hWindow = CreateWindowExW(WS_EX_TOOLWINDOW | WS_EX_TOPMOST | WS_EX_LAYERED,
        RectWindow::szClassName, nullptr, WS_POPUP,
